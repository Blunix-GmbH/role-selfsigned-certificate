# blunix.role-selfsigned-certificate
This Ansible role generates a self signed certificate with dhparam.  
It is mainly used for molecule tests where a ssl certificate is required.
